...
export interface MikeDocument {
  ...
  latest_signature_request?: MikeSignatureRequestSummary | null;
}

export type MikeSignatureStatus =
  | "draft"
  | "sent"
  | "viewed"
  | "partially_signed"
...
export interface MikeSignatureRequestSummary {
  id: string;
  status: MikeSignatureStatus;
  provider: string;
...
export interface MikeSignatureRecipient {
  id: string;
  ...
  status: "pending" | "sent" | "viewed" | "signed" | "declined" | "completed";
...
export interface MikeSignatureEvent {
  id: string;
  event_type: string;
...
export interface MikeSignatureRequest extends MikeSignatureRequestSummary {
  document_id: string;
  ...
  created_at: string;
  updated_at: string;
  recipients: MikeSignatureRecipient[];
  events?: MikeSignatureEvent[];
