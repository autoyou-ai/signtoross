...
export const OLLAMA_MAIN_MODELS = ["ollama:default"] as const;
...
export const OLLAMA_MID_MODELS = ["ollama:default"] as const;
...
export const OLLAMA_LOW_MODELS = ["ollama:default"] as const;
