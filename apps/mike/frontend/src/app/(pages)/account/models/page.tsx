...
import { MODELS, type ModelOption } from "@/app/components/assistant/ModelToggle";
import {
    isModelAvailable,
        ...
        <div className="space-y-4">
            ...
            <div className="py-6">
                ...
                <p className="text-sm text-gray-500 mb-4 max-w-xl">
                    You can use cloud API keys or a backend-configured local
                    Ollama model when running your own instance of Mike.
                </p>
                                ...
                                return (
                                    <DropdownMenuItem
                                        ...
                                        title={
                                            !available
                                                ? provider === "ollama"
                                                    ? "Enable Ollama in the backend .env to use this model"
...
function ApiKeyField({
    ...
    const [draft, setDraft] = useState({ resetKey: hasSavedKey, value: "" });
    const [reveal, setReveal] = useState(false);
    const [isSaving, setIsSaving] = useState(false);
    const [saved, setSaved] = useState(false);
    const value = draft.resetKey === hasSavedKey ? draft.value : "";
    ...
    const handleSave = async () => {
        ...
        setIsSaving(false);
        if (ok) {
            setDraft({ resetKey: hasSavedKey, value: "" });
            setSaved(true);
